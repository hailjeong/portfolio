...
import { FETCH_USEDITEMS } from "../oldBoards/oldBoardList/OldBoardList.queries";
import OldBoardPaginationUI from "./OldBoardPagination.presenter";
...
export default function OldBoardPagination(props: IPagination) {
